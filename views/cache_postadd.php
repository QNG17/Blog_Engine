  ...
  <div class="col-lg-12">
    ...
    <form action="/post/add" method="post">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="title" name="title" placeholder="Post title" value="<?php echo(htmlentities($post['title'])); ?>">
      </div>
      <div class="form-group">
        <label for="tags">Tags</label>
        <input type="text" class="form-control" id="tags" name="tags" placeholder="Post tags (comma separated list)" value="<?php echo(htmlentities($post['tags'])); ?>">
      </div>
      <div class="form-group">
        <label for="content">Content</label>
        <textarea class="form-control" id="content" name="content" rows="10" value="<?php echo(htmlentities($post['content'])); ?>"><?php echo(htmlentities($post['content'])); ?></textarea>
      </div>
