...
<div class="row">
  <div class="col-lg-12">
    <p>Posted on: <?php echo(htmlentities( time2str($post['datestamp']) )); ?></p>
...
<div class="row">
  <div class="col-lg-12">
    <div class="btn-toolbar align-middle">
      ...
      <button class="btn btn-sm btn-primary mr-1 d-flex justify-content-center align-content-between" onclick="get('/post/edit/<?php echo(htmlentities($post['id'])); ?>')"><span class="material-icons">edit</span>&nbsp;Edit</button>
      <button class="btn btn-sm btn-danger mr-1 d-flex justify-content-center align-content-between" onclick="get('/post/delete/<?php echo(htmlentities($post['id'])); ?>')"><span class="material-icons">delete</span>&nbsp;Delete</button>
    </div>
  </div>
</div>
    </div>
