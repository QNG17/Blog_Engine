        ...
        <div class="row mt-3">
          <div class="card">
            <div class="card-header">
              <a href="post/view/<?php echo(htmlentities($post['id'])); ?>"><h5><?php echo(htmlentities( $post['title'] )); ?><span style='float:right;'><?php echo(htmlentities( time2str($post['datestamp']) )); ?></span></h5></a>
            </div>
            <hr />
            <div class="card-body">
              <p class="card-text"><?php echo(htmlentities( substr($post['content'], 0, 500) )); ?> <a href='/post/view/<?php echo(htmlentities( $post['id'] )); ?>'>... read more</a></p>
            </div>
            <?php  if ($post['tags']): ?>
